...
bg2 = pygame.image.load("intro.png")
...
# Game Title
pygame.display.set_caption("Snake By Tapesh")
...
def welcome():
    exit_game = False
    while not exit_game:
        gameWindow.blit(bg2, (100, 0))
        text_screen("Welcome to snakes", white, 320, 500)
        text_screen("Press ENTER to Play!", white, 300, 550)
...
# GameOverScreen
           ...
           text_screen("Score: " + str(score), white, 385, 50)
           for event in pygame.event.get():
               if event.type == pygame.QUIT:
                   exit_game = True
               if event.type == pygame.KEYDOWN:
